...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { id: 'trash-users', label: 'Trash Users', href: '/users/trash' },
    ]
  },
  {
    id: 'categories',
    ...
    subItems: [
      ...
      { id: 'trash-categories', label: 'Trash Categories', href: '/categories/trash' },
    ]
  },
  {
    id: 'prompts',
    ...
    subItems: [
      ...
      { id: 'trash-prompts', label: 'Trash Prompts', href: '/prompts/trash' },
    ]
  },
  ...
  { id: 'devices', label: 'Devices', icon: Icons.smartphone, href: '/devices' },
  {
    ...
    href: '/countries',
    subItems: [
      { id: 'add-country', label: 'Add Country', href: '/countries/add' },
      { id: 'trash-countries', label: 'Trash Countries', href: '/countries/trash' },
    ]
  },
