/**
 * Migration Script: Add isDeleted field to all existing users
 * 
 * This script adds the isDeleted field (set to false) to all users in the database
 ...
 * 
 * Usage:
 *   node scripts/migrate-users-soft-delete.js
 */
...
async function migrateUsersSoftDelete() {
  console.log('\n[START] Starting migration: Add isDeleted field to users...');
  console.log('================================================\n');
  ...
  try {
    ...
    console.log(`[INFO] Found ${snapshot.size} users in total\n`);
    ...
    for (const doc of snapshot.docs) {
      ...
      // Check if user already has isDeleted field
      if (data.isDeleted !== undefined) {
        totalSkipped++;
        console.log(`[SKIP] Skipped: ${data.name || data.email} (already has isDeleted field)`);
        continue;
      }
      ...
      console.log(`[QUEUE] Queued: ${data.name || data.email} (${data.email})`);
    ...
    console.log('================================================');
    console.log(`[INFO] Total users processed: ${snapshot.size}`);
    console.log(`[INFO] Users updated: ${totalUpdated}`);
    console.log(`[INFO] Users skipped: ${totalSkipped}`);
    console.log('================================================\n');
    ...
    console.log('');
    console.log('1. Index for active users query:');
    console.log('   Collection: users');
    console.log('   Fields: isDeleted (Ascending), createdAt (Descending)');
    console.log('');
    console.log('2. Index for deleted users query:');
    console.log('   Collection: users');
    console.log('   Fields: isDeleted (Ascending), deletedAt (Descending)');
    console.log('');
    console.log('3. Index for provider filter with deleted:');
    console.log('   Collection: users');
    console.log('   Fields: provider (Ascending), isDeleted (Ascending)');
    console.log('');
