...
const collections: Collection[] = [
  {
    ...
    fields: [
      ...
      { name: 'photoURL', type: 'string', required: false, description: 'Profile photo URL', example: 'https://example.com/photo.jpg' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'iconImage', type: 'string', required: false, description: 'Category icon URL', example: 'https://example.com/icon.png' },
      { name: 'order', type: 'number', required: true, description: 'Display order (lower first)', example: '1' },
      { name: 'searchCount', type: 'number', required: false, description: 'Total searches in category', example: '150' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'searchCount', type: 'number', required: false, description: 'Search count', example: '50' },
    ],
  },
  {
    id: 'prompts',
    ...
    fields: [
      ...
      { name: 'url', type: 'string', required: false, description: 'Generated image URL', example: 'https://example.com/image.jpg' },
      { name: 'tags', type: 'string[]', required: false, description: 'Array of tags', example: '["nature", "sunset"]' },
      { name: 'isTrending', type: 'boolean', required: false, description: 'Trending status', example: 'true' },
      { name: 'likes', type: 'number', required: false, description: 'Total likes count', example: '245' },
      { name: 'searchCount', type: 'number', required: false, description: 'Search count', example: '1200' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'categories', type: 'string[]', required: false, description: 'Assigned category IDs', example: '["cat_001", "cat_002"]' },
    ],
  },
  {
    ...
    fields: [
      ...
      { name: 'isActive', type: 'boolean', required: false, description: 'Plan visibility status', example: 'true' },
      { name: 'order', type: 'number', required: true, description: 'Display order', example: '1' },
    ],
  },
  {
